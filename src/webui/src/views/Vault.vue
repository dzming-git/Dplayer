...
.modal { width: 480px; max-width: 92vw; background: var(--bg-elevated, #1e1e22); border-radius: 12px; overflow: hidden; }
.modal-head { display: flex; align-items: center; justify-content: space-between; padding: 14px 18px; background: var(--bg-surface-2, #2a2a30); font-weight: 600; }
...
.modal-foot { display: flex; justify-content: flex-end; gap: 10px; padding: 14px 18px; border-top: 1px solid var(--border-subtle, #2e2e34); }
</style>
