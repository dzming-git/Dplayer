...
# 使用 os.getcwd() 来确保在各种启动方式下都能正确获取路径
...
for _p in [
    _THIS_DIR,
    os.path.join(_PROJECT_ROOT, 'msa-web'),   # utils/, service_manager
    ...
    try:
        ...
        try:
            ...
            if output_format == 'gif':
                ...
                # 1000/fps 即每帧对应的真实时长；fps 异常时回退到 8fps 兜底。
                if fps and fps > 0:
