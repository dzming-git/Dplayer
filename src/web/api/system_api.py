        ...
        def run_sync():
            ...
            try:
                ...
                if os.path.exists(script_path):
                    ...
                    log.runtime('INFO', f"同步完成: {result.returncode}")
                    ...
                    log.debug('ERROR', f"同步脚本不存在: {script_path}")
            except Exception as e:
                log.debug('ERROR', f"同步执行失败: {e}")
            finally:
