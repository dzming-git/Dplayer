...
def update_user(user_id):
    ...
    try:
        ...
        logger.info(f"用户信息已更新: {user.username} by {current_user.username}")
        return jsonify({
            'success': True,
            'message': '用户信息已更新',
            'user': user.to_dict()
...
def delete_user(user_id):
    ...
    try:
        ...
        logger.info(f"用户已删除: {username} by {current_user.username}")
        return jsonify({
            'success': True,
...
def reset_user_password(user_id):
    ...
    try:
        ...
        logger.info(f"用户密码已重置: {user.username} by {current_user.username}")
        return jsonify({
            'success': True,
